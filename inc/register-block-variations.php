 ...
 * @return void
 */
function mercisuzanne_register_block_variation() {
	wp_enqueue_script(
		'mercisuzanne-block-variations',
...
add_action( 'enqueue_block_editor_assets', 'mercisuzanne_register_block_variation' );
